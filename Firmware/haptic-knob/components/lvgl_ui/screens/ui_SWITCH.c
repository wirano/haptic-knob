...
void ui_SWITCH_screen_init(void)
{
    ...
    ui_Arc5 = lv_arc_create(ui_SWITCH);
    lv_obj_set_width(ui_Arc5, 380);
    lv_obj_set_height(ui_Arc5, 380);
    lv_obj_set_align(ui_Arc5, LV_ALIGN_CENTER);
    lv_arc_set_range(ui_Arc5, 0, 1);
    lv_arc_set_bg_angles(ui_Arc5, 245, -65);

    ui_Button6 = lv_btn_create(ui_SWITCH);
    ...
    ui_Label15 = lv_label_create(ui_SWITCH);
